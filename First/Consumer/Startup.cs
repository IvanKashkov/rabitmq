...
namespace Consumer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddRabbitMq(Configuration, new QueueSettings[]
            {
                new QueueSettings("Queue", 16, typeof(MessageConsumer)),
                new QueueSettings("Queue2", 16, typeof(Message2Consumer))
            });
        }
